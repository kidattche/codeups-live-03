...
<section class="l-mv p-mv">
      <div class="p-mv__inner">
        <div class="p-mv__header">
          <h3 class="p-mv__title">
            WEB<br class="u-mobile">
            DESIGN<br class="u-mobile">
            SPECIALIST
          </h3>
          <p class="p-mv__subtitle">
            お客様の夢を叶える<br class="u-mobile">
            Webサイトを制作
          </p>
          <div class="p-mv__btn">
    ...
    <section class="l-topnews p-news">
      <div class="p-news__inner l-inner">
        <div class="p-news__title c-section-header c-section-header--left">
          <h3 class="c-section-header__engtitle">NEWS</h3>
          <div class="c-section-header__jatitle">お知らせ</div>
        </div>
        <div class="p-news__items">
          <!-- ループ処理開始 -->
          <div class="p-news__item p-news-content">
            <div class="p-news-content__meta">
              <time datetime="2022-03-04" class="p-news-content__date"
                >2022.3.4</time
              >
              <p class="p-news-content__category">お知らせ</p>
            </div>
            <div class="p-news-content__link">
              <a href="" class="p-news-content__category__text"
                >Webデザインニュースサイト【ウェブマガジン】に取材いただきました</a
              >
            </div>
          </div>
          <!-- ループ終了 -->
    ...
    <section class="l-service p-service">
      <div class="p-service__inner l-inner">
        <div class="p-service__title c-section-header">
          <h3 class="c-section-header__engtitle">SERVICE</h3>
          <div class="c-section-header__jatitle">事業内容</div>
        </div>
        <div class="p-service__items">
          <div class="p-service__item p-card">
            <div class="p-card__img">
              <img src="<?php echo get_template_directory_uri()?>/images/common/service-1.jpg" alt="サービス画像１">
            </div>
          ...
          <div class="p-service__item p-card">
            <div class="p-card__img">
              <img src="<?php echo get_template_directory_uri()?>/images/common/service-2.jpg" alt="サービス画像１">
            </div>
              <div class="p-card__body">
                <h3 class="p-card__title">Webサイト制作</h3>
                <p class="p-card__text">
          ...
          <div class="p-service__item p-card">
            <div class="p-card__img">
              <img src="<?php echo get_template_directory_uri()?>/images/common/service-3.jpg" alt="サービス画像１">
            </div>
              <div class="p-card__body">
      ...
      <div class="p-works__inner l-inner">
        <div class="p-works__content">
          <div class="p-works__images">
            ...
            <div class="swiper-pagination js-works-paginations"></div>
          </div>
          <div class="p-works__text-body">
            <div class="p-works__title c-section-header">
              <h3 class="c-section-header__engtitle">WORKS</h3>
              <p class="c-section-header__jatitle">製作実績</p>
            </div>
    ...
    <section class="l-company p-company">
      <div class="p-company__inner l-inner">
          <div class="p-company__title c-section-header">
            <h3 class="c-section-header__engtitle">COMPANY</h3>
            <p class="c-section-header__jatitle">私たちについて</p>
          </div>
          <div class="p-company__contents">
            <h3 class="p-company__subtitle">
              <span class="p-company__yellow">サイトのゴール=</span
              ><br class="u-mobile" /><span class="p-company__yellow">夢を叶えること</span>
          </h3>
        ...
        <div class="p-recruit__contents">
          <div class="p-recruit__wrapper">
            ...
            <div class="p-recruit__title c-section-header">
              <h3 class="c-section-header__engtitle">RECRUIT</h3>
