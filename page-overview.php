    ...
    <div class="p-sub-mv">
      <div class="p-sub-mv__title">
        <div class="c-section-header c-section-header--white">
          ...
          <div class="c-section-header__jatitle c-section-header--white">私たちについて</div>
        </div>
      </div>
    </div>
    ...
    <section class="p-company p-company--subpage">
      <div class="p-company__inner l-inner">
          <div class="p-company__title c-section-header">
            <h1 class="c-section-header__subpage">メッセージ</h1>
          </div>
      ...
      <div class="p-company-info__inner l-inner">
        ...
        <dl class="p-company-info__items p-common-lists">
          ...
          <div class="p-company-info__map">
            <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d10883.665827435922!2d135.49803076886465!3d34.70154418911403!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x6000e68d95e3a70b%3A0x1baec822e859c84a!2z5aSn6Ziq6aeF!5e0!3m2!1sja!2sjp!4v1690942840600!5m2!1sja!2sjp" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
          </div>
          <div class="p-company-info__map-l">
            <a href="#" target="_blank" rel="noopener no-referrer">Google mapで見る
            </a>
          </div>
      </div>
    </div>
